...
import { X, Mail, Lock, User as UserIcon, Sparkles, CheckCircle2, CloudCheck } from 'lucide-react';
        ...
        {isSuccess ? (
          <div className="py-8 text-center animate-scaleUp">
            ...
            <p className="text-sm text-slate-600 mt-2">
              Your account & bookings are now synced across all your devices.
            </p>
          </div>
        ) : (
          <>
            ...
            <p className="text-sm text-slate-500 mt-1 mb-6">
              {mode === 'signin'
                ? 'Sign in to access your bookings on your phone, laptop, or tablet.'
                : 'Join millions of travelers enjoying guaranteed member rates and synced trips.'}
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {mode === 'signin' ? 'Sign In & Sync Bookings' : 'Create Account & Sync'}
              </button>
            </form>
